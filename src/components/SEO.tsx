...
export default function SEO() {
  useEffect(() => {
    // 1. Set Page Title
    document.title = "TNP Event Planner | Luxury Wedding & Event Scenography";
    ...
    setMeta("description", "TNP Event Planner is an ultra-premium, luxury event planning company crafting timeless royal, scenic, and destination wedding experiences globally.");
    setMeta("keywords", "luxury event planner, TNP Event Planner, wedding planning company, destination wedding planner, Udaipur wedding, Jaipur palace wedding, Dior style wedding, premium wedding organizer");
    setMeta("author", "TNP Event Planner");
    setMeta("robots", "index, follow");

    // 4. Inject Open Graph Tags
    setMeta("og:title", "TNP Event Planner | Ultra-Premium Luxury Event Planner", true);
    ...
    setMeta("og:site_name", "TNP Event Planner", true);

    // 5. Inject Twitter Card Tags
    setMeta("twitter:card", "summary_large_image");
    setMeta("twitter:title", "TNP Event Planner | Luxury Wedding & Event Scenography");
    ...
    const businessSchema = {
      ...
      "email": "concierge@tnpeventplanner.com",
      "address": {
        "@type": "PostalAddress",
